    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('postCredit') }}" method="post">
              <div class="form-row align-items-center">
                ...
                <div class="col-auto mt-3" style="margin-left: 10rem;">
                  ...
                  <button id="showClientDetails" class="btn btn-secondary">Cancel</button>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
             ...
             <!-- <label for="exampleFormControlInput1">Invoice Number</label>
               <input type="number" class="form-control" id="exampleFormControlInput1" name="invoice_number" value=" @foreach($showClient as $field) {{ $no++}} @endforeach" readonly> -->
               <br>
...
<!-- <div class="row" id="cardMoreOptions">
...
<!-- Bootstrap dynamic sortable tables - Bootsnip -->
      ...
      <tbody>
       <tr id='addr0' data-id="0" class="hidden">
        ...
        <td data-name="tes" class="select-product">
          ...
          {{-- <select class="" id="select-dropdown" name='tes'>
...
<a id="add_row" class="btn btn-primary float-right" style="color: white">Add Row</a>
</div>
</div>
</div>
