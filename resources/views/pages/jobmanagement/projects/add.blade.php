...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
          ...
          <form action="{{ route('postaddprojects') }}" method="post" enctype="multipart/form-data"> 
            @csrf     
              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('full_name') is-invalid @enderror" id="exampleFormControlInput1" placeholder="Project name" name="project_name">
                        @error('full_name')
                      ...
                      <div class="form-group">
                            ...
                            <select class="js-example-basic-single form-control" name="client_id" id="client_id">
                                ...
                                <option value="{{ $value->id }}" data-company="{{ $value->business_name }}" data-address="{{ $value->street }}">{{ $value->full_name }}</option>
                                @endforeach
                            </select>
                      </div>
                      <div class="form-group">
                        <label for="exampleFormControlInput1">Status</label>
                        <select class="select-dropdown custom-select" name="status_information">
                      ...
                      {{-- <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tagging') is-invalid @enderror" id="tagging" data-role="tagsinput" placeholder="Tag" name="tagging">
                        @error('city')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror 
                      </div> --}}
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('full_name') is-invalid @enderror" placeholder="Company Name" name="company_name" id="company_name">
                      @error('full_name')
                      <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('full_name') is-invalid @enderror" placeholder="Address name" name="address_name" id="address_name">
                    </div>
                </div>
                </div>
