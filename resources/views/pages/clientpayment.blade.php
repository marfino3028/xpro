  ...
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
      <div class="page-title d-flex">
        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Client Payments</span></h4>
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
      <div class="d-flex">
        <div class="breadcrumb">
          ...
          <span class="breadcrumb-item active">Client Payments</span>
        </div>
        ...
        <table id="Example1" class="table table-lg invoice-archive">
          <thead>
            <tr>
              ...
              <th class="text-left">Clients Numbers</th>
