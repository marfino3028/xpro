...
<div class="content-wrapper">
  <section class="content">
    ...
    @if (session('success'))
      ...
      <div class="card">
        <div class="card-body">
        <h5 class="m-0 font-weight-bold text-primary">Project Asset Edit</h5>
                  ...
                  <div class="row">
                    ...
                    <label for="exampleFormControlInput1">Project Name</label>
                        <select class="js-example-basic-single form-control" name="project_name" id="project_name">
                            ...
                            <option value="{{ $value->project_name }}" data-company="{{ $value->company_name }}" @if($data->project_name == $value->project_name) selected @endif>{{ $value->project_name }}</option>
                            @endforeach
                        </select>
                    </div> 
                    ...
                    <label for="exampleFormControlInput1">Company Name</label>
                          <input type="text" readonly class="form-control" placeholder="Company Name" value="{{ $data->company }}" name="company" id="company">
                    </div>  
                  </div>
