            ...
            <div class="form-row align-items-center">
              ...
              <div class="col-auto mt-1">
                <select class="select-dropdown custom-select" id="select1" name="id_clients">
                  ...
                  <option value="{{ $field -> id}}" {{$field ->id == $showEdit[0]->id_client ? 'selected' : ''}}>{{ $field -> full_name}}</option>
                  @endforeach
                </select>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="form-row align-items-center">
             <div class="col-7">
               ...
               <input type="date" class="form-control" id="exampleFormControlInput2" placeholder="" name="invoice_date" value="{{$showEdit[0]->invoice_date}}">
               <br>
               <label for="exampleFormControlInput1">Issue Date</label>
               <input type="date" class="form-control" id="exampleFormControlInput3" placeholder="" name="issue_date" value="{{$showEdit[0]->issue_date}}">
               <br>
               <label for="exampleFormControlInput1">Payment Terms</label>
               <div class="input-group">
                <input type="number" min="0" max="60" class="form-control" placeholder="" aria-label="" aria-describedby="" name="payment_terms" value="{{$showEdit[0]->payment_terms}}">
...
<div class="col-lg-12 mb-4">
  <div class="card shadow mb-4">
    ...
    var fixHelperModified = function(e, tr) {
      ...
      console.log(document.getElementById('#select1').val());
    </script>
    @endsection