...
<div class="navbar navbar-expand-md navbar-dark navbar-static">
  <div class="navbar" style="min-width: 15.625rem;">
    <a href="/dashboard" class="d-inline-block">
      <img src="/assets/images/logo_light.png" alt="" style="width: 130px; margin-left:27px; margin-bottom: -5px;">
    </a>
  </div>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
          <div class="dropdown-content-header">
            ...
            <a href="/add_message" class="text-default"><i class="icon-compose"></i></a>
          </div>
                ...
                <div class="media-body">
                  <div class="media-title">
                    <a href="#">
                      ...
                      <span class="text-muted float-right font-size-sm">Waktu</span>
                    </a>
                  </div>

                  <span class="text-muted">Isi pesan ..</span>
                </div>
              </li>
            </ul>--}}
          </div>
    ...
    @foreach (session('showStaff') as $showStaff)
      <li class="nav-item dropdown dropdown-user">
        <a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
          <img src="/assets/images/photo_profile/{{ $showStaff['photo'] }}" class="rounded-circle mr-2" height="34" alt="">
          <span>{{ $showStaff['name'] }}</span>
        </a>

        <div class="dropdown-menu dropdown-menu-right">
          <a href="/account_information" class="dropdown-item"><i class="icon-user-plus"></i> My profile</a>
          <a href="/manage_salary" class="dropdown-item"><i class="icon-coins"></i> My balance</a>
          ...
          <a href="/account_settings" class="dropdown-item"><i class="icon-cog5"></i> Account settings</a>
