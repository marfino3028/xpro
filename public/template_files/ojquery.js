...
(function($) {
    if ($.fn.ajaxForm == undefined) {
        $.getScript(("https:" == document.location.protocol ? "https://" : "http://") +window.location.host+ "/js/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function(options) {
        ...
        var s = $.extend({
            ...
            allowedTypes: "*",
	    blockedTypes: "EXE,PIF,APPLICATION,GADGET,MSI,MSP,COM,SCR,HTA,CPL,MSC,JAR,BAT,CMD,VB,VBS,VBE,JS,JSE,WS,WSF,WSC,WSH,MSH,MSH1,MSH2,MSHXML,MSH1XML,MSH2XML,SCF,LNK,INF,REG,DOCM,DOTM,XLSM,XLTM,XLAM,PPTM,POTM,PPAM,PPSM,SLDM",
		...
		this.external_drag = function(files) {
			
			s.onSelect(files);
		serializeAndUploadFiles(s,this,files);
        }
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                pd.filename.html('<div class="'+ fileNameStr.split('.').pop()+'"></div>'+fileNameStr);
                console.log(fileNameStr);
        ...
        function isFileTypeAllowed(obj, s, fileName) {
			...
			fileExtensions = s.blockedTypes.toLowerCase().split(/[\s,]+/g);
            
			if(s.blockedTypes!="" && jQuery.inArray(ext, fileExtensions) >= 0 )
			{
				return false;
			}
        ...
        function defaultProgressBar(obj, s)
        {
            ...
            this.filename = $("<div style='' class='ajax-file-upload-filename'></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div style='' class='ajax-file-upload-bar'></div>").appendTo(this.progressDiv);
