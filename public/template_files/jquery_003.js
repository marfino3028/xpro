...
(function($) {
	...
	$.fn.lightbox_me = function(options) {
		...
		return this.each(function() {
			...
			if (opts.closeButton){
				$self.append('<a class="lb-close" id="LBClose">close</a>');
				$('.lb-close', this).click(function(){
					removeModal(true);
					return false;
				});
			}
			...
			$self.find(opts.closeSelector).click(function() {
				removeModal(true);
				return false;
			});
