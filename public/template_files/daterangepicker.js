	...
	$.fn.daterangepicker = function(settings){
		...
		var options = $.extend({
			...
			presets: {
				...
				allDatesBefore: __('All Dates Before'),
				allDatesAfter: __('All Dates After')
		},
		rangeStartTitle: __('Start date'),
		rangeEndTitle: __('End date'),
		nextLinkText: __('Next'),
		prevLinkText: __('Prev'),
		target: rangeInput,
		doneButtonText: 'Done',
